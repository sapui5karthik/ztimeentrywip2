		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ztimeentrywip2",
									"targetURL": "#comchappotawippoc2wipproject2wip2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchappotawippoc2wipproject2wip2-display": {
								"semanticObject": "comchappotawippoc2wipproject2wip2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.chappota.wippoc2.wipproject2.wip2",
									"url": sap.ui.require.toUrl("com/chappota/wippoc2/wipproject2/wip2")
								}
							}
						}
					}
